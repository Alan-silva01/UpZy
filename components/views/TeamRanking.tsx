...
export const TeamRanking: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="pb-28 space-y-5 flex items-center justify-center h-96" style={{ paddingTop: 'calc(env(safe-area-inset-top) + 5rem)' }}>
  ...
  if (sellers.length === 0) {
    return (
      <div className="pb-28 space-y-5" style={{ paddingTop: 'calc(env(safe-area-inset-top) + 5rem)' }}>
        <div className="px-1">

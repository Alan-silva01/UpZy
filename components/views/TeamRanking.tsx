...
import { Crown, ChevronDown, ShoppingBag, Trophy, Calendar, Filter } from 'lucide-react';
            ...
            {clientes.map((cliente, index) => {
              ...
              return (
                <div
                  ...
                  className={`glass-card rounded-2xl p-3.5 hover:bg-white/5 transition-all duration-300 ${index < 3 ? 'border-white/10' : ''
                    }`}
                >
                  <div className="flex items-center gap-3">
                    {medal ? (
